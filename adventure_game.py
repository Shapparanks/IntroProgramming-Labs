...
and you were being chased by a dark figure in an abandoned insane asylum. As you were running, you stumble
...
if hes ok. He says to you, "thank you ''' + name + ''', you saved my life".''')
    print('''
You earned''', 0 + 25, '''points
    ''')
    input("Press enter to continue")
    print('''
You and ''' + friend1 + ''' make your way out of the showers and enter the cafeteria, you
notice that there is a very sweet smell in the air. You both look at each other with confused expressions,
...
You open the pot and luckily the liquid inside was warm and not boiling. You pull her out of the pot and she says, 
...
said, " ''' + name + ''', thank you, I really don't know what I would have done without you.''')
    print('''
Congratulations, you earned''', 25 + 25, '''points!
    ''')
    input("Press enter to continue")
    print('''
...
''')
    print('''
You got away from the dark figure, you earned''', 50 + 25, '''points!
''')
    input("Press enter to continue")
    print(''' 
...
friends and start hysterically laughing.''')
    print('''
You finally met the old man! He was only trying to help. You earned''', 75 + 25, '''Points!''')
    print('''
